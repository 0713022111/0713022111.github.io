...
```  
![Alt text](http://liyufeng.angton.com/DNS1.png)  
![Alt text](http://liyufeng.angton.com/DNS2.png)  
![Alt text](http://liyufeng.angton.com/DNS3.png)  
![Alt text](http://liyufeng.angton.com/DNS4.png)  
DNS搭建结束。
